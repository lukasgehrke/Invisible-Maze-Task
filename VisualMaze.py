...
class VisualMaze(BaseExperiment):
    ...
    def rvd_task(self):
        ...
        print '!!! MAUSKLICK TO START RVD TASK !!!'
        yield self.hide_inst_continue_left_mouse()
    ...
    def assign_trackers(self, trackers):
        ...
        trackers.sort(reverse = True)

        t0_ix = trackers.index(tracker0_z)
        t1_ix = trackers.index(tracker1_z)
        t2_ix = trackers.index(tracker2_z)

        if t0_ix is 0:
            self.hand_tracker_id = 0
        elif t1_ix is 0:
            self.hand_tracker_id = 1
        elif t2_ix is 0:
            self.hand_tracker_id = 2

        if t0_ix is 1:
            self.arm_tracker_id = 0
        elif t1_ix is 1:
            self.arm_tracker_id = 1
        elif t2_ix is 1:
            self.arm_tracker_id = 2

        if t0_ix is 2:
            self.torso_tracker_id = 0
        elif t1_ix is 2:
            self.torso_tracker_id = 1
        elif t2_ix is 2:
            self.torso_tracker_id = 2
    ...
    def trial(self):
        ...
        print '!!! CLICK TO START EXPLORATION !!!'
        yield self.hide_inst_continue_left_mouse()
        ...
        print '!!! START REACHED: RVD & REWALKING TASK !!!'
        ...
        if not self.current_maze is 'I' and self.current_trial_run < 3:
            ...
            print '!!! NAECHSTEN DURCHGANG MIT TASTE N STARTEN !!!'
    ...
    def pause(self):
        ...
        if self.current_maze is 'I':
            ...
            print '!!! PAUSE? WEITER MIT TASTE W !!!'
    ...
    def experiment_procedure(self, maze, id, run):
        ...
        print '!!! START LABRECORDER DATA COLLECTION !!!'
        yield self.hide_inst_continue_left_mouse()
